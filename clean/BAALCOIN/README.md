BAALCoin - an educational cryptocurrency based on SmallChange.
...
http://www.ocf.berkeley.edu/~baisang/BAALCoin.pdf
which details the process of using this repository to create your own aBACoin,
