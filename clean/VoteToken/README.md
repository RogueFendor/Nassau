VoteTokenCoin - an educational cryptocurrency based on SmallChange.
...
http://www.ocf.berkeley.edu/~baisang/VoteTokenCoin.pdf
which details the process of using this repository to create your own aVToin,
